...
// 打印生成的四元式
{
    ...
    case 1:
    {
        ...
        if (arg1.var == NULL)
            ...
            std::cout << this->printOp() << "\t" << this->arg1.var->getName() << "\t" << this->arg2.target << "\t" << this->result.target << std::endl;
        break;
    }
    case 2:
    {
        if (arg2.var == NULL)
            std::cout << this->printOp() << "\t" << this->arg1.target << "\t" << this->arg2.var->getName() << "\t" << this->result.target << std::endl;
        else
    ...
    case 3:
    {
        if (arg1.var == NULL)
        {
            if (arg2.var == NULL)
                ...
                std::cout << this->printOp() << "\t-\t" << this->arg2.var->getName() << "\t" << this->result.target << std::endl;
        }
        else
        {
            if (arg2.var == NULL)
                std::cout << this->printOp() << "\t" << this->arg1.var->getName() << "\t-\t" << this->result.target << std::endl;
            else
                std::cout << this->printOp() << "\t" << this->arg1.var->getName() << "\t" << this->arg2.var->getName() << "\t" << this->result.target << std::endl;
        }
        break;
    }
    case 4:
    {
        if (result.var == NULL)
            ...
            std::cout << this->printOp() << "\t" << this->arg1.target << "\t" << this->arg2.target << "\t" << this->result.var->getName() << std::endl;
    }
    break;
    case 5:
    {
        if (arg1.var == NULL)
            ...
            std::cout << this->printOp() << "\t" << this->arg1.var->getName() << "\t" << this->arg2.target << "\t";

        if (result.var == NULL)
            std::cout << "-" << std::endl;
        else
            std::cout << this->result.var->getName() << std::endl;
    }
    break;
    case 6:
    {
        if (arg2.var == NULL)
            ...
            std::cout << this->printOp() << "\t" << this->arg1.target << "\t" << this->arg2.var->getName() << "\t";
        if (result.var == NULL)
            std::cout << "-" << std::endl;
        else
            std::cout << this->result.var->getName() << std::endl;
    ...
    case 7:
    {
        if (arg1.var == NULL)
            ...
            std::cout << this->printOp() << "\t" << this->arg1.var->getName() << "\t";
        if (arg2.var == NULL)
            std::cout << "-\t";
        else
            std::cout << this->arg2.var->getName() << "\t";
        if (result.var == NULL)
            std::cout << "-" << std::endl;
        else
            std::cout << this->result.var->getName() << std::endl;
